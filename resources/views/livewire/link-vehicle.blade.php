    ...
    >
        ...
        <x-slot name="content">
            <div class="mt-3">
                ...
                <h3 class="my-4 text-center"> {{ __('Empresa que solicita la vinculación') }} </h3>
                <div class="row">
                    <div class="col-12">
                        <x-select
...
@push('scripts')
    <script type="text/javascript">
        document.addEventListener('livewire:initialized', () => {
            @this.on('show-link-vehicle-modal', ( ) => {
                bootstrap.Modal.getOrCreateInstance(document.getElementById('linkVehicle')).show();
